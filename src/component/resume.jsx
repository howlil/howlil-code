...
import { edu, experience,organization } from "../data/expertData";
  ...
  return (
    <div className="p-8 max-sm:p-1  hover:bg-neutral-900 transition-all duration-500 ease-in-out rounded-xl">
        ...
        <div className="relative">
          {/* Vertical line */}
          <div className="absolute w-0.5 bg-gray-300 dark:bg-gray-700 h-full left-5 md:left-3.5 max-sm:left-3.5"></div>
